...
class IRC_Server:
    ...
    def getUsers(self, l):
        ...
        for i, v in enumerate(l):
            ...
            l[i] = v if '\r\n' not in v[-2:] else v[:-2]
        if 'MasBot' in l: l.remove('MasBot')
    ...
    def running(self):
        ...
        while connected:
            ...
            elif 'JOIN' in line or 'PART' in line: self.getUserlist(self.irc_current_channel)
